...
class TestExtractFont:
    def test_produces_correct_glyph_count(self, acsf_brave_ttf_path):
        result = extract_font(
            acsf_brave_ttf_path, opts=FontConversionOptions(is_cursive=True, charset="basic")
        )
    ...
    def test_correct_height(self, acsf_brave_ttf_path):
        result = extract_font(acsf_brave_ttf_path, opts=FontConversionOptions(is_cursive=True))
